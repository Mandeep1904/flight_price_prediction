        ...
        <div className="flex flex-col md:flex-row items-center justify-between p-10 md:p-20">
          ...
          <div className="md:w-1/2 text-center md:text-left">
            <h2 className="text-3xl font-bold text-gray-800">
              Check out better flight deals
            </h2>
            <p className="text-gray-600 mt-4 text-lg">
              Flight price prediction helps travelers estimate ticket prices in
              advance, allowing them to book at the best possible rates. It
              utilizes machine learning and past trends to provide accurate
              insights.
            </p>
            <p className="text-gray-600 mt-2 text-lg">
              This website is designed to help you find the best time to book
              your flight and save money on air travel.
            </p>
          </div>
